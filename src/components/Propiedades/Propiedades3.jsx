...
const Propiedades3 = () => {
    ...
    <div className="prox">
        ...
        <p>CASA A LA VENTA A ESTRENAR EN SAN JAVIER - AMBIENTE AMPLIO CON ENTREPISO, COCINA Y BA�O. COCHERA - TODO SOBRE LOTE DE 5.000 M� CON ESCRITURA - MUY BUEN ACCESO Y HERMOSA VISTA A LAS SIERRAS. CONSULTE !!!.</p>
        <Carousel>
                <div className="ca">
