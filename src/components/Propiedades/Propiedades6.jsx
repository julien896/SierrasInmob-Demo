...
const Propiedades6 = () => {
    ...
    <div className="prox">
        ...
        <p>CASA A LA VENTA EN ACHIRAS ABAJO - SAN JAVIER, SOBRE LOTE DE 3.450 M² CON ESCRITURA Y 6.350 M² 
            CON DERECHOS POSESORIOS, LA CASA CUENTA CON UN DORMITORIO, UN BAÑO, COCINA Y LIVING CON HOGAR A LEÑA 
            INTEGRADOS, HERMOSA ARBOLEDA Y VISTA A LAS SIERRAS, FRUTALES. CONSULTE !!!.</p>
